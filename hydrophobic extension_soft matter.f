...
cccccccccccccccccccccccccccccccccccccccccccccc
	...
	OPEN(111,FILE='Beta_kappab_MOB.dat')
...
c       List of parameters
        bts1=100.0   !(bts1:Nastar,n12)
        
1234   continue
        
        bts2=(1.0/ab)*bts1
        alp1=1.0             !(alp1:Nbstar,n100)
        alp2=ab*alp1
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	Actual_mob=aMu1+aMu2+aMu3+aMu4
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 	write(*,*)   pH, aMu1+aMu2+aMu3+aMu4,ITRN_C




        if( (pH.ge.2).and.(pH.lt.12.0)) then
	pH=pH+0.29
	go to 12
